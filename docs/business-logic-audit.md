...
### BL-01 — Marker можна підробити вмістом розмови (P0)
...
### BL-02 — State може захопити сторонній notebook (P0)
...
### BL-03 — Немає блокування паралельних імпортів (P1)
...
### BL-04 — Повне сканування всіх Joplin notes є головним bottleneck (P1)
...
### BL-05 — State повністю кодується та `fsync`-иться після кожного чату (P1)
...
### BL-07 — HTTP token дозволено надсилати відкритим текстом на віддалений host (P1)
...
### BL-10 — Частковий успіх не відображений у підсумку та немає preflight усіх мутацій (P2)
